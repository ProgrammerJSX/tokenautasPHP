...
<body>
    <div class="container" style="transform: scale(0.8);">
        <div class="login__content" style="margin-top: -30px;">
            ...
            <form action="../Controladores/RegistroControlador.php"  method="post" class="login__form">
                <div>
                    <h1 class="login__title">
                        <span style="color: #1c0e2a;">Registrarse</span> 
                    </h1>
                ...
                <input type="hidden" name="action" value="register">
                    ...
                    <a href="./login.php" class="login__forgot" style="color: #1c0e2a;">Ya tienes cuenta? Ven a Iniciar Sesion!</a>
                </div>
            </form>
        </div>
    </div>
