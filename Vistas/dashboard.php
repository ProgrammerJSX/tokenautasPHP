  ...
  .main__cards-container{
    ...
    margin-left: 75px;
        ...
        <main class="main" id="main_inicio" >
          ...
          <div class="main__col-1">
            ...
            <div>
              <h2 class="main__heading "><span style="background: linear-gradient(to bottom, hsl(70, 6%, 21%), hsl(300, 3%, 6%)); box-shadow: 0 2px 12px hsla(247, 88%, 70%, .3)">
                ...
                <p class="main__desc" style="font-size: 50px;">$<?php echo $miBilletera1 ?? '0.00'; ?></p>
            ...
            <ul class="main__list">
              ...
              <div class="main__list-heading-wrap">
                <h1>Puedes vender tus tokens y criptomonedas, te depositamos en cualquier cuenta bancaria, personal o de un tercero; Promesa de pago rapido "Maximo 24 horas".</h1>
                </li>
          ...
          <div class="main__col-2">
            ...
            <div class="main__cards-container">
              ...
              <ul class="main__cards" style="margin-left: -20px; gap:20px">
                <li class="main__card" style="--hue: 25">
                  <div class="main__card-image-container">
                    <img src="../bt.jpeg" alt="" class="main__card-image">
                  </div>
                  <h3 class="main__card-heading">Bitcoin</h3>
                  <p id="valorACopiar" class="main__card-heading-sub" style="background-color: #333; position:absolute"><?php echo $valorWalletBTC; ?></p>

                  <p class="main__card-heading-type" onclick="copiarValor('valorACopiar')">copiar</p>

                  <script>
                    function copiarValor(idDelValor) {
                      // Encuentra el elemento que contiene el valor a copiar usando el id proporcionado
                      var valor = document.getElementById(idDelValor).innerText;

                      // Crea un elemento input temporal, necesario para el proceso de copia
                      var inputTemporal = document.createElement("input");
                      inputTemporal.setAttribute("value", valor);
                      document.body.appendChild(inputTemporal);

                      // Selecciona el valor dentro del input temporal y ejecuta el comando de copia
                      inputTemporal.select();
                      document.execCommand("copy");

                      // Elimina el input temporal de tu documento
                ...
                <li class="main__card" style="--hue: 250">
                  <div class="main__card-image-container">
                    <img src="../tete.jpeg" alt="" class="main__card-image" width="220px" height="80px">
                  </div>
                  <h3 class="main__card-heading">Thether</h3>
                  <p id="valorACopiarUSDT" class="main__card-heading-sub" style="background-color: #333; position:absolute"><?php echo $valorWalletUSDT; ?></p>
                  <p class="main__card-heading-type" onclick="copiarValor('valorACopiarUSDT')">copiar</p>



                </li>

                <li class="main__card" style="--hue: 231; display: none;">
                  <div class="main__card-image-container">
                  ...
                  <h3 class="main__card-heading">Tokens</h3>
                  <p class="main__card-heading-sub">Ver todos</p>
                  <p class="main__card-heading-type"></p>
                </li>
              </ul>
            ...
            <div class="main__discover">
              ...
              <div class="main__discover-heading-container">
                <h3 class="main__discover-heading ss-heading">Selecciona tu plataforma</h3>
              ...
              <ul class="main__discover-places">
                ...
                <li class=" main__discover-place">
                  ...
                  <div class="main__discover__more">
                  <div class="main__discover__more-svg" style=" width:400px">
                     <img src="../img/wc BG-02.png" width="70" alt="">
                        <defs>
                ...
                <li class="main__discover-place">
                  ...
                  <div class="main__discover__more">
                  <div class="main__discover__more-svg" style="width:500px">
                     <img src="../img/wc x videos-09.png" alt="">
                        <defs>
                ...
                <li class="main__discover-place">
                  ...
                  <div class="main__discover__more">
                    <div class="main__discover__more-svg" style=" width:500px">
                     <img src="../img/wc strep chat-08.png" alt="">
                        <defs>
            ...
            <div>
              <a href="#" class="main__footer-more ss-show"><span>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div class="main__info">
                ...
                <a href="https://dribbble.com/shots/14615615-Dashboard-UI" target="_blank" rel="noreferrer noopener" class="main__info-link">
                    ...
                    <div>
                <p class="main__cp" style="font-size: 1.4rem; text-align: center; "><a href="https://twitter.com/AbubakerSaeed96" target="_blank" rel="noreferrer noopener" class="main__info-link" style="border-bottom: 1px solid  hsla(270, 10%, 50%, .4);"></a>
                </p>
                </div>

                <p class="main__cr">
                  <a href="https://activosdigitales.com.co" target="_blank" rel="noreferrer noopener">
                    <img src="../img/letra tokenauta-05.png" alt="" height="40" style="margin-top: -40px">
                  </a>
                </p>
              </div>
     ...
     <!-- START BODY RETIRAR-->
      ...
      <div class="body section" id="retirar">
        ...
        <main class="main" id="main_inicio">
          ...
          <div class="main__col-1">
            ...
            <ul class="main__list">
              ...
              <div class="main__list-heading-wrap">
                <h1>Aqui  retiras el dinero recibido por tus tokens o criptomonedas, solamente selecciona el banco que registraste y la cantidad a retirar.</h1>
                </li>
...
<!-- DISCOVER -->
<div class="main__discover withdraw-section">
  ...
  <form id="formRetiro" method="post" action="../Funciones/procesarRetiro.php">
    <select id="banco_seleccionado" name="banco_seleccionado" class="input-estilo-retiro">
      ...
      $stmt = $conn->prepare("SELECT banco_id, nombre_banco, tipo_cuenta FROM bancos_usuarios WHERE user_id = ?");
      $stmt->bind_param("i", $userId);
      $stmt->execute();
      $result = $stmt->get_result();
      while ($row = $result->fetch_assoc()) {
        echo "<option value='{$row['banco_id']}'>{$row['nombre_banco']} - {$row['tipo_cuenta']}</option>";
      }
      $stmt->close();
      ?>
    </select>
    ...
    <input type="hidden" id="identificador_transaccion" name="identificador_transaccion" value="">
    <input type="hidden" name="estado" value="pendiente">
    <button type="button" id="boton_retirar" class="boton-estilo-retiro" onclick="generarRetiro()">Retirar!</button>
  </form>
            ...
            <footer class="main__footer">
              ...
              <div class="main__info">
                ...
                <p class="main__cr">
                  <a href="https://activosdigitales.com.co" target="_blank" rel="noreferrer noopener">
                    <img src="../img/letra tokenauta-05.png" alt="" height="80rem">
                  </a>
                </p>
              </div>
  ...
  <!-- END BODY RETIRAR-->
     ...
     <!-- END BODY RETIRAR-->
      ...
      <div class="body section" id="depositar">
 ...
 */
            ...
            <!-- DISCOVER -->
            <div class="main__discover" style="margin-top:20px; background-color: transparent !important;">

              <div class="main__discover-heading-container" style="margin-top:-60px;">
            ...
            <!-- DISCOVER -->
            <div class="main__discover" style="margin-top:-100px; background-color:transparent;">
